...
INSERT INTO `city_points` (`city`,`latitude`,`longitude`) VALUES 
('Aachen',50.7764,6.08386),
('Albuquerque',35.0841,-106.651),
 ('Anchorage',61.2163,-149.895),
('Århus',56.1496,10.2134),
('Barcelona',41.3829,2.17743),
('Barquisimeto',10.074,-69.3216),
('Bergamo',45.7567,9.75422),
('Berlin',52.517,13.3889),
('Bern',46.9483,7.45145),
('Boise',43.6166,-116.201),
('Bräcke',62.7833,15.6667),
('Brandenburg',52.8456,13.2461),
('Bruxelles',50.8466,4.3517),
('Buenos Aires',-34.6076,-58.4371),
('Butte',39.6519,-121.586),
('Campinas',-22.9056,-47.0608),
('Caracas',10.5061,-66.9146),
('Charleroi',50.412,4.44362),
('Cork',51.8986,-8.47059),
('Cowes',50.7576,-1.30356),
('Cunewalde',51.0985,14.5145),
('Elgin',42.0373,-88.2811),
('Eugene',44.0505,-123.095),
('Frankfurt a.M.',50.1106,8.68209),
('Genève',46.2018,6.1466),
('Graz',47.0709,15.4383),
('Helsinki',60.1675,24.9427),
('I. de Margarita',10.4021,-66.7983),
('Kirkland',47.686,-122.192),
('Köln',50.9384,6.95997),
('København',55.6867,12.5701),
('Lander',39.906,-116.984),
('Leipzig',51.3406,12.3747),
('Lille',50.6366,3.06353),
('Lisboa',38.7078,-9.13659),
('London',51.5073,-0.127647),
('Luleå',65.5831,22.146),
('Lyon',45.7578,4.83201),
('Madrid',40.4167,-3.70358),
('Mannheim',49.4896,8.46724),
('Marseille',43.2962,5.36995),
('México D.F.',22.5,-100),
('Montréal',45.4972,-73.6104),
('München',48.1371,11.5754),
('Münster',51.9625,7.62519),
('Nantes',47.2186,-1.55414),
('Oulu',65.0119,25.4717),
('Paris',48.8567,2.35146),
('Portland',45.5202,-122.674),
('Reggio Emilia',44.6087,10.5948),
('Reims',49.2578,4.03193),
('Resende',-22.4684,-44.4464),
('Rio de Janeiro',-22.911,-43.2094),
('Salzburg',47.7981,13.0465),
('San Cristóbal',7.77567,-72.2214),
 ('San Francisco',37.779,-122.42),
 ('São Paulo',-23.5507,-46.6334),
('Seattle',47.6038,-122.33),
('Sevilla',37.3886,-5.99534),
('Stavern',58.9983,10.036),
('Strasbourg',48.5846,7.75071),
('Stuttgart',48.7785,9.18001),
('Torino',45.0678,7.68249),
('Toulouse',43.6045,1.44425),
('Tsawwassen',49.0243,-123.076),
('Vancouver',49.2609,-123.114),
('Versailles',48.8035,2.12669),
 ('Walla',50.9419,16.4919),
 ('Walla Walla',46.0667,-118.339);
...
CREATE PROCEDURE `w3_insert_points`(
    IN city varchar(255),
    IN latitude float,
    IN longitude float
